...
static JNINativeMethod sScannerMethods[] = {
        ...
        {"nativeStartScan",           "(JLcom/gaozhongkui/garbagescanner/scanner/FileScanner$ScanCallback;)I",(void *) jniStartScan},
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    static const char *const className = "com/gaozhongkui/garbagescanner/scanner/FileScanner";
