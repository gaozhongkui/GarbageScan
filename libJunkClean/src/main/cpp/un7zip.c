...
//Java_com_ihs_device_clean_junk_util_CompressUtil_getLzmaVersion(JNIEnv *env, jclass type) {
//    return (*env)->NewStringUTF(env, MY_VERSION);
//}
//
//JNIEXPORT jint JNICALL
//Java_com_ihs_device_clean_junk_util_CompressUtil_un7zip(JNIEnv *env, jclass type, jstring filePath_, jstring outPath_) {
...
//
//JNIEXPORT jint JNICALL
//Java_com_ihs_device_clean_junk_util_CompressUtil_un7zipFromAssets(JNIEnv *env, jclass type, jobject assetManager,
